...
# Add a category column to identify test and train in each dataset to later merge both datasets
x_test_all<-mutate(x_test_all,group="test")
x_train_all<-mutate(x_train_all,group="train")
